...
> 기술 컨텍스트 이전에 사업 맥락부터 잡을 것. 모든 코드 결정(카피, UX, 기능 우선순위)은
> 아래 전략 방향과의 정합성을 먼저 체크한다.

### Master Strategy Doc

**@docs/strategy/Ideation.md** — 벙커샷파트너스 피드백 5차례 전체 아카이브 및 분석
- Problem Definition → Research 1·2·3번 슬라이드 개선안
- 포지셔닝 옵션 A vs B 비교
- Next Action 체크리스트 13개
- **새 세션 시작 시 이 문서를 먼저 참조할 것**

### 중요 전략 결정사항 (2026-04 기준)

- **포지셔닝 방향**: 옵션 B ("AI Trade Agent for Korean Manufacturers") 검토 중
  - 옵션 A: "Apollo for Korean Manufacturers" (도구, 월 50~100만원, BEP 30사)
  - 옵션 B: "AI Trade Agent" (결과물, 월 200~500만원, BEP 10사) ← 벙커샷 추천 방향

- **페르소나 구조**: Dual Persona
  - Primary Buyer: 매출 50~200억 제조사 **대표**
  - Internal Champion: 수출 담당자

- **타겟 ICP**: 매출 50~200억 × 인증 게이트 산업(의료·자동차·화학) × 해외영업 1~2명 × 과거 수출 실패 경험

- **Research 3번 핵심 통찰**: 진짜 경쟁은 Apollo가 아니라 "구글링 + 엑셀 + 번역기 콜드메일" 같은 한국 중소제조사의 아날로그 수출 현장

### 코드 작업 시 전략 정합성 체크리스트

랜딩페이지, Pricing, Problem/Solution 섹션 등 **고객 대면 카피 수정 시**:

- ❌ **금지**: "저렴한 도구", "월 50만원", "비용 절감", "수출 담당자의 업무 효율화"
- ✅ **권장**: "예측 가능한 파이프라인", "가치 기반 가격", "대표의 성장 엔진", "매몰비용 방지"
- ❌ **경쟁 비교 기준선**: Apollo, LinkedIn
- ✅ **경쟁 비교 기준선**: 구글링+엑셀 아날로그 방식, 무역 대행사

Problem 섹션 작성 시:
- "회신율 0%" 같은 추상적 표현 대신 매몰비용 숫자("수개월 영업 인건비 수천만원 증발") 강조
- 타깃 톤: "수출 담당자의 업무 고충" 이 아닌 "대표의 성장 정체 위기감"

### 주요 마일스톤

- **예비창업패키지 결과**: 2026년 5~6월 대기 중
- **CTO 채용 타겟**: 2026년 7월 (옵션 B 선택 시 AI 자동화 경험자 우선)
- **BEP 타겟**: 2027년 H1

### 관련 리소스

- **Claude.ai NEXPORT Project**: 벙커샷 피드백 분석 및 전략 논의용 (Ideation.md 업로드됨)
- **VOC 기록**: Scott (자동차부품), Peter (수처리) — 실명 포함, private 리포 유지
- **피드백 원본 아카이브**: `docs/strategy/bunkershot-feedback/` (추후 추가 예정)
