...
export const MOCK_BUYERS: Buyer[] = [
  // ── GOLD (회신 이력 보유) ──
  { id: 'b01', maskedName: 'Aqua*** Inc.', summary: '캘리포니아 소재 산업용 수처리 설비 유통사입니다.', region: '미국 · 캘리포니아', industry: '수처리', employees: '50~200명', matchReason: '수처리 키워드 유사도 + NSF 인증 수입 이력', grade: 'GOLD', status: 'replied', sentAt: daysAgo(9), openedAt: daysAgo(8), attachOpenedAt: daysAgo(7), repliedAt: daysAgo(6), bounces: 0, offPlatform: false, matchCount: 1 },
  ...
  // ── SILVER (열람/첨부 신호) ──
  { id: 'b05', maskedName: 'Blu*** Filtration', summary: '플로리다에서 멤브레인 필터를 취급하는 수처리 전문 수입상입니다.', region: '미국 · 플로리다', industry: '수처리', employees: '10~50명', matchReason: '멤브레인 필터 키워드 유사도 상위', grade: 'SILVER', status: 'opened', sentAt: daysAgo(4), openedAt: daysAgo(2), bounces: 0, offPlatform: false, matchCount: 1 },
  ...
  { id: 'b08', maskedName: 'Cle*** Water Tech', summary: '지자체 상수도 프로젝트를 수행하는 조지아 소재 엔지니어링사입니다.', region: '미국 · 조지아', industry: '수처리', employees: '50~200명', matchReason: '상수도 자재 조달 공고 이력', grade: 'SILVER', status: 'none', bounces: 0, offPlatform: false, matchCount: 1 },
  ...
  // ── BRONZE (미검증 신규) ──
  { id: 'b10', maskedName: 'Ind*** Supply LLC', summary: '산업용 배관·밸브 자재를 취급하는 오하이오 종합 자재상입니다.', region: '미국 · 오하이오', industry: '수처리', employees: '50~200명', matchReason: '배관 자재 카테고리 인접 + 신규 소싱 시그널', grade: 'BRONZE', status: 'sent', sentAt: daysAgo(8), bounces: 0, offPlatform: false, matchCount: 1 },
  ...
  { id: 'b12', maskedName: 'Hyd*** Solutions', summary: '펌프·수압 설비를 취급하는 콜로라도 산업 설비사입니다.', region: '미국 · 콜로라도', industry: '수처리', employees: '10~50명', matchReason: '펌프 설비 키워드 유사도', grade: 'BRONZE', status: 'none', bounces: 0, offPlatform: false, matchCount: 0 },
  ...
  { id: 'b15', maskedName: 'Gre*** Environmental', summary: '환경 설비·폐수 처리 솔루션을 다루는 오리건 업체입니다.', region: '미국 · 오리건', industry: '수처리', employees: '50~200명', matchReason: '폐수 처리 카테고리 일치', grade: 'BRONZE', status: 'none', bounces: 0, offPlatform: false, matchCount: 0 },
  ...
  { id: 'b18', maskedName: 'Fil*** Media Corp.', summary: '여과재·필터 미디어를 전문 취급하는 미네소타 업체입니다.', region: '미국 · 미네소타', industry: '수처리', employees: '10~50명', matchReason: '여과재 키워드 유사도 상위', grade: 'BRONZE', status: 'none', bounces: 0, offPlatform: false, matchCount: 0 },
  // ── COLD (추천 제외 — UI 비노출, 관리자 데이터) ──
  { id: 'b19', maskedName: 'Sta*** Industrial', summary: '범용 산업재 유통사 — 3회 매칭 무반응.', region: '미국 · 켄터키', industry: '수처리', employees: '50~200명', matchReason: '-', grade: 'COLD', status: 'none', bounces: 0, offPlatform: false, matchCount: 3 },
  ...
  { id: 'b22', maskedName: 'Pla*** Water Co.', summary: '수처리 자재상 — 3회 매칭 무반응.', region: '미국 · 네바다', industry: '수처리', employees: '10~50명', matchReason: '-', grade: 'COLD', status: 'none', bounces: 0, offPlatform: false, matchCount: 3 },
  // ── DEAD (폐기 — UI 비노출) ──
